class Transaction {
  ...
  factory Transaction.fromJson(Map<String, dynamic> json) {
    ...
    return Transaction(
      ...
      uploaderFirstName: uploaderStudentData?['stud_fn']?.toString(),
      uploaderMiddleInitial: uploaderStudentData?['stud_mi']?.toString(),
      uploaderLastName: uploaderStudentData?['stud_ln']?.toString(),
      transactYear: year,
      transactMonth: month,
      transactDay: day,
